            ...
            <div className='w-[40vw] mx-auto'>
                ...
                <div className='flex gap-x-2 my-2 items-center'>
                    <div className='w-[100%]'>
                        ...
                        <div id="myStateList" onClick={(e) => setDropDownStates(value => !value)} name="myStateList" className='w-[100%]  overflow-auto border-black border-2 rounded-md px-2 py-1'>Select a State
                ...
                {dropDownStates && <div className='overflow-auto h-[150px]'>
                ...
                {<div className='px-1 py-1 bg-blue-500 text-white mt-1 rounded-md'>
                    Selected States:
                    <div className='flex gap-2 flex-wrap pb-3 px-2 pt-1'>
                        {selectedStateList.map((state, index) => {
                            return (
                                <div key={index} value={state} onClick={() => removeState(state)} className='border-black border-2 rounded-md px-1 py-1 flex items-center gap-x-2 bg-white text-black' >{state} <TiDelete className='text-2xl' /></div>
                            )
                        })}
